...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { difficulty: @professor.difficulty, name: @professor.name, rating: @professor.rating, subject: @professor.subject } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { difficulty: @professor.difficulty, name: @professor.name, rating: @professor.rating, subject: @professor.subject } }
